    ...
    <div className=" py-16 px-4 sm:px-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h2 className="text-3xl sm:text-4xl font-bold mb-2">A Blog About Software Development And Life</h2>
          <p className="dark:text-gray-300 mb-6">Welcome to my blog. Subscribe and get my latest blog post in your inbox.</p>
        ...
        <div className="flex justify-center mt-10 space-x-2">
          ...
          {Array.from({ length: totalPages }, (_, i) => (
            <button
              ...
              className={`px-3 py-1 rounded ${currentPage === i + 1 ? 'bg-blue-500' : ' outline-1 outline-[#bcbcbc] rounded-full hover:bg-blue-400'} `}
            >
              {i + 1}
            </button>
          ))}
